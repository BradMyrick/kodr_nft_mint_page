  ...
  if (isMobile) {
    return (
      <div className="mint w-max mx-auto mt-0">
        <div className="about__content m-auto p-1 w-screen">
          <div className="about__content__title ">
            <h1>AI Horror</h1>
          </div>
          <div className="textbox font-din">
            <p>
              A collection of images from the AI Horror Nights project. <br/> The project is a collection of 1000 unique images, each one generated by an AI model trained on aliens and horror movie posters.
              <br /><br />
